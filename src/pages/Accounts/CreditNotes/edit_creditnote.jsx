    ...
    PublicFetch.get(`${ACCOUNTS}/credit-note/${id}`)
      .then((res) => {
        ...
        if (res.data.success) {
          ...
          console.log("daatatat", res.data.data);
          ...
          editForm.setFieldsValue({
            ...
            credit_note_lead_id: res.data.data.credit_note_lead_id,
            // invoiceno: ,
            // credit_note_voucher_no:res.data.data.credit_note_voucher_no,
            // credit_note_voucher_no:res.data.data.credit_note_voucher_no,
          });
          getonelead(res.data.data.credit_note_lead_id);
        }
      })
      .catch((err) => {
  ...
  const getonelead = async (data) => {
    ...
    try {
      ...
      if (getlead?.data.success) {
        ...
        setAllCustomer(getlead?.data?.data);
      }
    } catch (err) {
      console.log(err);
    }
