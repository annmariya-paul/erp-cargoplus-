  ...
  var converter = require('number-to-words');
    ...
    return(
        ...
        <div className=" row mt-4 m-0 p-0  quotation_border_bottom">
          <h5 className="headcolorquot d-flex justify-content-center  mb-4">QUATATION</h5>
          <div className="col-6 d-flex">
            <div className="col-4">Quotation No</div>
            <div className="col-1">:</div>

            <div className="col-7">
              <p className="modal-view-data quotation_p_name">{allqoutation?.quotation_no}</p>
            </div>
          </div>
          ...
          <div className="col-6 d-flex">
            ...
            <div className="col-7">
              <p className="modal-view-data  quotation_p_name"> 
              {moment(allqoutation?.quotation_date).format("DD-MM-YYYY")}</p>
            </div>
          </div>
          <div className="col-6 d-flex">
          ...
          {/* <div className="col-6 d-flex">
            ...
            <div className="col-7">
              <p className="modal-view-data quotation_p_name">{allqoutation?.quotation_mode}</p>
            </div>
          </div> */}
          ...
          <div className="col-6 d-flex">
            ...
            <div className="col-7">
              <p className="modal-view-data quotation_p_name">{allqoutation?.crm_v1_units?.unit_name}</p>
            </div>
          </div>
...
<table class="table   p-0 m-0">
  ...
  {tabledata && tabledata.map((itm,indx)=> (
      ...
      <tr>
        ...
        <th className="border_right text_align_words">{itm.service_name} </th>
        <th className="border_right text_align_number">{itm.quotation_details_cost} </th>
        <th className="border_right text_align_words">{itm.tax_type_name} </th>
...
<div className="col-6">
  {
    allqoutation &&
<p className="font_weight_qt" >{converter.toWords(allqoutation?.quotation_grand_total)} </p>
  }
</div>
<div className="col-6  ">
  <div className="row">
