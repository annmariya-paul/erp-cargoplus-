...
invoice_table_header={
  ...
  <th scope="col" className="font_weight_qt  border_right text_align_number">AWB/BL NO</th>
  <th scope="col" className="font_weight_qt border_right text_align_words">JOB NO</th>
  <th scope="col" className="font_weight_qt border_right text_align_number">AMOUNT</th>
  <th scope="col" className="font_weight_qt text_align_number">TAX</th>
  <th scope="col" className="font_weight_qt text_align_number">TAX %</th>
  <th scope="col" className="font_weight_qt text_align_number">TAX AMOUNT</th>
