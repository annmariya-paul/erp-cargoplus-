          ...
          <div className="container-fluid ">
            <div className="row  mt-3 ">
              <div className="col-xl-6 col-lg-2 col-md-3 col-sm-12 ">
                <h4 className="lead_text">View Debit Notes</h4>
              </div>
                ...
                <div className="row justify-content-end mx-2 py-3">
                  ...
                  <div className="col-xl-2 col-lg-2 col-md-3 col-sm-12 mb-3 ">
                    <Button
                      ...
                      onClick={() => {
                        // handleviewtoedit();
                        navigate(`${ROUTES.EDIT_DEBIT_NOTES}/${id}`);
                      }}
                    >
                      Edit
                      <FiEdit />
            ...
            <div className="row ms-1 mb-3 ">
              <div className="content-tabs-new row justify-content px-4">
                ...
                <div className="col-xl-12 col-sm-12 d-flex">
                  <div className="col-4 boldhd">Purchase No</div>
                  <div className="col-1">:</div>
                ...
                <div className="col-xl-12 col-sm-12 d-flex">
                  <div className="col-4 boldhd">Purchase Amount</div>
                  <div className="col-1">:</div>
                ...
                <div className="col-xl-12 col-sm-12 d-flex">
                  <div className="col-4 boldhd">Amount</div>
                  <div className="col-1">:</div>

                  <div className="col-7">
                    <p className="modal-view-data">29023</p>
                  </div>
                </div>
                <div className="col-xl-12 col-sm-12 d-flex">
                  <div className="col-4 boldhd">Type</div>
                  <div className="col-1">:</div>
